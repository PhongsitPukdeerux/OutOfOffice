...
const Footer = () => {
  return (
    <footer className="w-full bg-yellow text-gray-800 py-8 px-4 md:px-12 font-sans mt-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0">
        {/* Left Section: Logo and Copyright */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          {/* Placeholder for the logo. You can replace this with an actual image. */}
          <h1 className="font-clash-display text-4xl text-white ml-2 mb-2 leading-tight">
            Ready to Collab!
          </h1>
          <img
          ...
          />
          <p className="text-xs text-white font-helvetica">
            @ ALL RIGHTS RESERVED. 2025 OUT OF OFFICE
          </p>
        </div>

        {/* Right Section: Contact and Info */}
        <div className="font-clash-display text-white flex flex-col md:flex-row justify-end space-y-8 md:space-y-0 md:space-x-16 w-full md:w-auto">
          {/* Contact Section */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h1 className="text-xl text-white md:text-2xl font-bold mb-4">
              Let’s Connect
            </h1>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <button
                className="bg-transparent border-2 text-white font-semibold py-2 px-4 rounded-lg flex items-center justify-center space-x-2 hover:scale-105 cursor-pointer"
                onClick={() => alert("Live Chat functionality would go here.")}
              >
                <svg
                  width="32"
                  height="32"
